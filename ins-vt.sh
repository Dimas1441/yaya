...
# install v2ray
wget https://raw.githubusercontent.com/Dimas1441/yaya/main/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
echo -e "Selesai Terinstall V2ray Sevices" | lolcat
figlet -f slant BRODY | lolcat
sleep 1
wget https://raw.githubusercontent.com/Dimas1441/yaya/main/domen1.sh && chmod +x domen1.sh && ./domen1
wget https://raw.githubusercontent.com/Dimaz1441/yaya/main/domen2.sh && chmod +x domen2.sh && ./domen2
rm -f domen1.sh
rm -f domen2.sh
rm -f ins-vt.sh
