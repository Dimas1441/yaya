...
vlesslink1="vless://${uuid}@${domain}:$tls?path=/brody&security=tls&encryption=none&type=ws#${user}"
vlesslink2="vless://${uuid}@${domain}:$none?path=/brody&encryption=none&type=ws#${user}"
